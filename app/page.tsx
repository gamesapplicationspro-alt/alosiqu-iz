...
export default function Home() {
  ...
  return <main className="flex min-h-screen items-center justify-center bg-gradient-to-br from-amber-100 via-yellow-50 to-orange-100 p-4 dark:from-amber-950 dark:via-yellow-950 dark:to-orange-950">
    <section className="w-full max-w-2xl rounded-2xl border-2 border-amber-300 bg-white/90 p-6 text-center shadow-2xl backdrop-blur sm:p-10 dark:border-amber-800 dark:bg-stone-950/90">
      ...
      <h1 className="text-3xl font-black tracking-tight text-amber-900 sm:text-5xl dark:text-amber-100">Quiz Ιστορίας</h1>
      <p className="mx-auto mt-4 max-w-xl text-amber-800 dark:text-amber-200">Γρήγορο ζωντανό quiz ιστορίας για την Άλωση της Κωνσταντινούπολης.</p>
      ...
      <div className="mx-auto mt-6 grid max-w-md gap-3">
        ...
        <button onClick={() => router.push("/history")} className="rounded-xl border-2 border-amber-700 px-6 py-3 font-bold text-amber-900 dark:text-amber-100">📜 Ιστορικό αποτελεσμάτων</button>
      </div>
    </section>
  </main>;
}
