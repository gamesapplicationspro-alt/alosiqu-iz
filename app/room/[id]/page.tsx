...
type Room = { id: string; code: string; phase: GamePhase; questionIndex: number; round: number; version: number; questions: { id: string; text: string; answers: Answer[]; explanation?: string; source?: string }[]; phaseEndsAt: number | null; revealCorrectAnswerId: string | null; paused?: boolean; pausedRemainingMs?: number | null };
